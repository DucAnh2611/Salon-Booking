...
export default function ProductFeatureCard({
    ...
    return (
        <div className="w-full h-fit flex flex-col rounded-md border bg-background border-neutral-200 dark:border-neutral-700 box-border overflow-hidden group cursor-pointer gap-2 p-4">
