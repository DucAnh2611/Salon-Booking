...
import { setDeleteListRoleApi } from "@/lib/redux/actions/role.action";
...
import { roleColumnDef } from "../col-def/role";
...
export default function RoleDataTable({
    ...
    const { isCalling, isDeleting, isFailure } = useAppSelector(roleSelector);
        ...
        <div>
            ...
            <div className="flex items-center justify-end pt-3">
                <div className="flex-1 text-sm text-muted-foreground">
                    ...
                    {(page - 1) * limit + roles.length} trong tổng số {count}{" "}
                    bản ghi{" "}
                </div>
