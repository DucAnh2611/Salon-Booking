import ProductDataTable from "@/components/data-table/table/product";
...
import {
    deleteProductApi,
    listProductApi,
} from "@/lib/redux/actions/product.action";
...
export default function ProductScreen() {
    ...
    const handleReload = () => {
        dispatch(listProductApi(page, limit, key, orderBy));
    };
    ...
    const handleCreate = () => {
        navigate(`${ROUTER_PATH.PRODUCT}/add`);
    };

    const handleDelete = () => {
        dispatch(deleteProductApi(deleteItems));
    };
