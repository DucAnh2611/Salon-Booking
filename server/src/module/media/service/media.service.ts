...
import { FileFormatEnum } from '../../../enum/files.enum';
import { BadRequest, InternalServer } from '../../../exception/error.exception';
import { getDatePlusMinutes } from '../../../utils/parse-time.utils';
...
export class MediaService {
    ...
    async saveToTemp(file: Express.Multer.File, tempFileCreate: CreateTempMediaDto) {
        const { sessionId } = tempFileCreate;
        ...
        const fileName = multerConfig.format.temp
            ...
            .replace(FileFormatEnum.SESSION_EXPIRE, getDatePlusMinutes(60).getTime().toString());
