...
export const SEED_DATA: TSeedData = {
  ...
  role: [
    { deletable: false, title: ROLE_TITLE.client },
    { deletable: false, title: ROLE_TITLE.staff },
    { deletable: false, title: ROLE_TITLE.admin },
    { deletable: false, title: ROLE_TITLE.employee },
  ],
